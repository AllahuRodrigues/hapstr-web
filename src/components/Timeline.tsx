...
const steps = [
  { title:'Scan the Street',    text:'Point your phone and reveal live prices.' },
  { title:'Interior Transparency', text:'Walk around & peek inside instantly.' },
  { title:'Book an AR tour',    text:'Schedule agent-less viewing in Vision Pro.' },
];
  ...
  return (
    <section id="features" ref={ref} className="py-32 px-6">
      ...
      <div className="max-w-3xl mx-auto">
        {steps.map((s, i) => (
          <div key={i} className="step relative pl-10 border-l border-brand/50 mb-16 last:mb-0">
